...
// Generated: 2026-04-02T04:28:01.598Z
...
describe('outputs', () => {
  it('outputs_readOutputFile_reads_file_content', async () => {
  ...
  it('outputs_substituteVariables_replaces_placeholders', async () => {
  ...
  it('outputs_substituteVariables_preserves_unknown_placeholders', async () => {
  ...
  it('outputs_renderOutput_renders_template_with_variables', async () => {
  ...
  it('outputs_renderOutput_reads_file_without_variables', async () => {
  ...
  it('outputs_formatErrorList_formats_errors_with_numbers', async () => {
  ...
  it('outputs_formatErrorList_returns_empty_string_for_empty_array', async () => {

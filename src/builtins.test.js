...
// Generated: 2026-04-02T04:15:01.337Z
...
describe('builtins', () => {
  it('reads_tsconfig_correctly', async () => {
  ...
  it('TRANS09_jest_uses_tsconfig_defaults', async () => {
  ...
  it('TRANS01_createJestMapper_generates_test_file_with_it_blocks', async () => {
  ...
  it('TRANS03_includes_source_path_and_notice_in_header', async () => {
    const mapper = createJestMapper();
    const snippets = [
  ...
  it('TRANS04_deduplicates_imports_in_generated_tests', async () => {
    const mapper = createJestMapper();
    const snippets = [
  ...
  it('TRANS08_auto_imports_source_file_exports', async () => {
    const mapper = createJestMapper();
    const snippets = [
  ...
  it('TRANS10_vitest_uses_tsconfig_defaults', async () => {
  ...
  it('SDK03_loads_jest_builtin_mapper', async () => {
    const mapper = await loadBuiltInMapper('jest', '.');
    expect(typeof mapper).toBe('function');
  });

  it('SDK03_loads_vitest_builtin_mapper', async () => {
    const mapper = await loadBuiltInMapper('vitest', '.');
    expect(typeof mapper).toBe('function');
  });

  it('SDK03_exports_builtInConfigs_with_jest_and_vitest', async () => {

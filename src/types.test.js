...
// Source: src/types.ts
// Generated: 2026-04-02T06:32:01.281Z
...
describe('types', () => {
  it('SDK02_snippetInfo_type_usage', async () => {
  ...
  it('SDK02_mapperResult_type_usage', async () => {
  ...
  it('SDK02_mapperFunction_type_usage', async () => {
  ...
  it('SDK02_generateOptions_type_usage', async () => {
  ...
  it('SDK02_config_type_usage', async () => {
    const config: Config = {
      include: ["src/**\/*.ts"],
      exclude: ["**\/*.test.ts"],
      rootDir: "./src",

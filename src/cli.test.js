...
// Source: src/cli.ts
// Generated: 2026-04-02T06:32:01.269Z
...
describe('cli', () => {
  it('CLI01_help_flag_shows_usage_info', async () => {
  ...
  it('CLI01_version_flag_shows_package_version', async () => {
  ...
  it('CLI04_missing_config_shows_clear_error', async () => {
    expect(() => runCli('--config=nonexistent-config.mjs')).toThrow();
  });

  it('CLI04_invalid_config_path_shows_error', async () => {
    expect(() => runCli('--config=/path/that/does/not/exist.mjs')).toThrow();
  });

  it('CLI05_include_flag_overrides_config_pattern todo: fix this test - it will always pass', async () => {
    cleanDir('custom-output');
  ...
  it('CLI05_exclude_flag_filters_out_files', async () => {
    cleanDir('custom-output');
  ...
  it('CLI06_outDir_flag_overrides_default_output_directory', async () => {
  ...
  it('CLI07_rootDir_flag_overrides_source_root', async () => {
    cleanDir('root-tests');

...
| **TRANS08** | **Auto Source Import**: Generated test files automatically import all exports from the source file, removing the need for users to manually import the method-under-test in their @example blocks (see [backlog](./backlog/auto-source-import.md)) | Unit tests via @example in `builtins.ts` | [x] | [ ] | [x] |

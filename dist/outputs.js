...
exports.formatSampleConfig = formatSampleConfig;
 ...
 */
function frameContent(content, width, title, theme = 'default') {
 ...
 */
async function renderOutput(filename, options = {}, cwd) {
    ...
    const contentWidth = Math.max(...content.split('\n').map(line => line.length), options.title ? options.title.length + 4 : 0);
 ...
 */
async function printOutput(filename, options = {}, cwd) {
 ...
 */
async function printErrorAndExit(filename, options = {}, exitCode = 1, cwd) {
